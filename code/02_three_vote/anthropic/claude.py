...
def parse_json_label(raw_text: str) -> str:
    ...
    # الأفضل non-greedy / محدود لالتقاط JSON صغير
...
def call_model(model_id: str, model_name: str, text: str, temperature: float, sample_i=None, vote_i=None):
    ...
    for attempt in range(1, MAX_RETRIES + 1):
        try:
            ...
            # Claude SDK عادةً يعيد content list
            raw = ""
...
for MODEL_NAME, MODEL_ID in MODELS.items():
    ...
    summary_rows.append({
        ...
        "model_name": MODEL_NAME,
        "run_id": RUN_ID,
        "setup": "zero-shot + self-consistency",
        "votes": VOTES,
...
print("\nClaude benchmark completed successfully (UNIFIED, 3 votes, no tiebreak).")
print("RUN_ID:", RUN_ID)
